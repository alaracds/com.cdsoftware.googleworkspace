 ...
 *
 * Copyright (C) 2024 cdsoftware and contributors (see README.md file).
 */

package com.cdsoftware.googleworkspace.util;

import static com.cdsoftware.googleworkspace.test.util.RandomTestUtil.*;
import static com.cdsoftware.googleworkspace.test.util.ReflectionTestUtil.*;
...
class KeyValueLoggerTest {
	...
	void shouldPrintClassFromClass() {
		...
		verifyStringLog(Level.INFO, "class=\"com.cdsoftware.googleworkspace.util.KeyValueLogger\"");
	}
	...
	void shouldPrintPackageFromClass() {
		...
		verifyStringLog(Level.INFO, "package=\"com.cdsoftware.googleworkspace.util\"");
	}
