...
- New callout
  - Name: CName
  - Package: com.cdsoftware.googleworkspace.callout
  - Example: com.cdsoftware.googleworkspace.callout.CStringFormat

- New process
  - Name: PName
  - Package: com.cdsoftware.googleworkspace.process
  - Example: com.cdsoftware.googleworkspace.process.PGenerateWithholding

- New form
  - Name: FName
  - Package: com.cdsoftware.googleworkspace.form
  - Example: com.cdsoftware.googleworkspace.form.FMultiPayment

- New event
  - Name: EName
  - Package: com.cdsoftware.googleworkspace.event
  - Example: com.cdsoftware.googleworkspace.event.EAfterCompleteInvoice

- New model (extends class X)
  - Name: MName
  - Package: com.cdsoftware.googleworkspace.model
  - Example: com.cdsoftware.googleworkspace.model.MTableExample
...
```text
    com.cdsoftware.googleworkspace
        ...
        |   |_ProcessFactory.xml
        |_src
            |_com.cdsoftware.googleworkspace
                |_base (plugin core)
...
- New callout
  - Create callout in package `com.cdsoftware.googleworkspace.callout`, extends from `CustomCallout`
  - Annotate it with the `@Callout` annotation at class level

- New process
  - Create process in package `com.cdsoftware.googleworkspace.process`, extends from `CustomProcess`
  - Annotate it with the `@Process` annotation at class level

- New form
  - Create form in package `com.cdsoftware.googleworkspace.form`, extends from `CustomForm`
  - Annotate it with the `@Form` annotation at class level

- New event
  - Create event in package `com.cdsoftware.googleworkspace.event`, extends from `CustomEvent`
  - Annotate it with the `@EventTopicDelegate` annotation at class level

- New model (extends form class X)
  - Create model in package `com.cdsoftware.googleworkspace.model`, extends class `X`. Example: `X_TL_TableExample -> MTableExample`
